      ...
      (event) => {
        ...
        void drag(
          ...
          (_dragged, target) => {
            ...
            void this.eventTarget.dispatchEvent(
              new CustomEvent('notintersecting', {
                detail: { thisEl: this.dragged, withEl: target },
              })
            )
          },
...
var controlsArr = Array.from(document.querySelectorAll('[data-swap-set]'))
var swapSets = []
...
var replaceDemo = document.querySelector('[data-replace-demo]')
var appendDemo = document.querySelector('[data-append-demo]')
var replaceTemplate = document.querySelector('#replace-demo-template')
var appendTemplate = document.querySelector('#append-demo-template')
